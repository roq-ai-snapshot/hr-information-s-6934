  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Information System - Streamlining your employee data management, vacation planning, and payroll processes for an efficient workforce."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Information System - Streamlining your employee data management, vacation planning, and payroll processes for an efficient workforce.`}
            </Text>
            <Box
